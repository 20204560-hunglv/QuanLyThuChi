...
import quanlythuchi.components.LabelHeaderHinhThuc1;
import quanlythuchi.components.PieChart;
import quanlythuchi.components.ScrollBar;
import quanlythuchi.components.TableHeader;
...
public class Home extends javax.swing.JFrame {
    ...
    private TaiKhoan tk;
    private int index = -1, indexSlideBefore, indexColor, indexThongBao = -1;
...
//        modelPieCharts = cd.tongTienCuaTheLoaiChi(tk.getIdTaiKhoan());
        modelPieCharts = cd.tongTienCuaTheLoaiChiTime(tk.getIdTaiKhoan(), firstTime, seconTime);
...
//        jTableThongBao.setShowHorizontalLines(true); //trong properties của jtable1
...
// Scroll
    ...
    private void initComponents() {
        ...
        comboBox1 = new quanlythuchi.components.ComboBox();
        jSeparator4 = new javax.swing.JSeparator();
        txtTheLoai = new quanlythuchi.components.ComboBox<>();
        jLabel35 = new javax.swing.JLabel();
        comboBoxTLcon1 = new quanlythuchi.components.ComboBox<>();
        jLabel36 = new javax.swing.JLabel();
        jLabel37 = new javax.swing.JLabel();
        txtThoiGian = new quanlythuchi.components.TextField();
        txtMoTa = new quanlythuchi.components.TextField();
        ...
        search = new quanlythuchi.components.ComboBox();
        searchtextField = new quanlythuchi.components.TextField();
        SuaButton = new quanlythuchi.components.Button();
        XoaButton = new quanlythuchi.components.Button();
        LamMoiButton = new quanlythuchi.components.Button();
        jLabel16 = new javax.swing.JLabel();
        ChonThangCBBox = new quanlythuchi.components.ComboBox();
        jPanelBieuDo1 = new javax.swing.JPanel();
        btnChon1 = new quanlythuchi.components.Button();
        textDenNgay1 = new quanlythuchi.components.TextField();
        textTuNgay1 = new quanlythuchi.components.TextField();
        button1 = new quanlythuchi.components.Button();
        PanelBieuDo = new javax.swing.JPanel();
        jLabel10 = new javax.swing.JLabel();
        jSeparator1 = new javax.swing.JSeparator();
        jPanel4 = new javax.swing.JPanel();
        pieChart2 = new quanlythuchi.components.PieChart();
        jScrollPaneBieuDo = new javax.swing.JScrollPane();
        jTableBieuDo = new javax.swing.JTable();
        comboBox3 = new quanlythuchi.components.ComboBox();
        jPanel8 = new javax.swing.JPanel();
        comboBoxBieuDo = new quanlythuchi.components.ComboBox();
        jPanelChooseDate1 = new javax.swing.JPanel();
        btnChon = new quanlythuchi.components.Button();
        textDenNgay = new quanlythuchi.components.TextField();
        textTuNgay = new quanlythuchi.components.TextField();
        histogramPanel1 = new quanlythuchi.components.HistogramPanel();
        ...
        button5 = new quanlythuchi.components.Button();
        ...
        panelSlideHanMuc = new quanlythuchi.components.PanelSlide();
        jPanelHan_Muc_1 = new javax.swing.JPanel();
        jPanel3 = new javax.swing.JPanel();
        button3 = new quanlythuchi.components.Button();
        button8 = new quanlythuchi.components.Button();
        ...
        button33 = new quanlythuchi.components.Button();
        jLabel55 = new javax.swing.JLabel();
        jPanel15 = new javax.swing.JPanel();
        jLabel43 = new javax.swing.JLabel();
        jFormattedTextField1 = new javax.swing.JFormattedTextField();
        jLabel44 = new javax.swing.JLabel();
        textField1 = new quanlythuchi.components.TextField();
        jLabel45 = new javax.swing.JLabel();
        comboBox4 = new quanlythuchi.components.ComboBox();
        button9 = new quanlythuchi.components.Button();
        jPanel1 = new javax.swing.JPanel();
        DangxuatButton = new quanlythuchi.components.Button();
        jPanel6 = new javax.swing.JPanel();
        buttonHome = new quanlythuchi.components.Button();
        buttonGiaoDich = new quanlythuchi.components.Button();
        buttonSetting = new quanlythuchi.components.Button();
        buttonThongBao = new quanlythuchi.components.Button();
        jLabel17 = new javax.swing.JLabel();
        Slide = new quanlythuchi.components.PanelSlide();
        ...
        pieChart1 = new quanlythuchi.components.PieChart();
        histogramPanel = new quanlythuchi.components.HistogramPanel();
        jLabel7 = new javax.swing.JLabel();
        jLabel8 = new javax.swing.JLabel();
        jPanel12 = new javax.swing.JPanel();
        comboBox2 = new quanlythuchi.components.ComboBox();
        ...
        comboBoxTL = new quanlythuchi.components.ComboBox<>();
        txt_sotien = new quanlythuchi.components.TextField();
        txt_thoigian = new quanlythuchi.components.TextField();
        txt_mota = new quanlythuchi.components.TextField();
        comboBoxThuChi = new quanlythuchi.components.ComboBox();
        comboBoxTLcon = new quanlythuchi.components.ComboBox<>();
        ...
        button6 = new quanlythuchi.components.Button();
        button7 = new quanlythuchi.components.Button();
        ...
        DialogHanMuc.setPreferredSize(new java.awt.Dimension(400, 600));
        ...
        jPanel14Layout.setHorizontalGroup(
            ...
            .addComponent(jScrollPaneHanMuc, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
        );
        jPanel14Layout.setVerticalGroup(
            jPanel14Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanel14Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jScrollPaneHanMuc, javax.swing.GroupLayout.DEFAULT_SIZE, 537, Short.MAX_VALUE))
        );
...
//        Time();
    ...
    private void XoaButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_XoaButtonActionPerformed
        // TODO add your handling code here:
//        Id_GiaoDich = cd.getIdGiaoDich(tk.getIdTaiKhoan(), getSttRowjTable());
        if (index >= 0) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            jLabelNoteGD.setText("");
        } catch (Exception e) {
            jLabelNoteGD.setText("Vui lòng nhập đúng định dạng");
        }
        list.clear();
        thangNay();
        getTableTime(firstTime, seconTime);
    ...
    private void button5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button5ActionPerformed
        // TODO add your handling code here:
        noteMK.setText("");
        if (MKcu.getText().equals("") || MKmoi.getText().equals("") || MKconfirm.getText().equals("")) {
            noteMK.setText("Hãy điền đầy đủ thông tin!");
        } else if (!MKmoi.getText().equals(MKconfirm.getText())) {
            noteMK.setText("Mật khẩu không giống nhau");
        } else if (!MKcu.getText().equals(tk.getMatKhau())) {
            noteMK.setText("Mật khẩu không đúng");
        } else if (cd.changePass(MKmoi.getText(), tk.getIdTaiKhoan())) {
            noteMK.setText("Thành công!");
            tk.setMatKhau(MKmoi.getText());
            MKcu.setText("");
            MKmoi.setText("");
            MKconfirm.setText("");
        } else {
            noteMK.setText("Có lỗi xảy ra!");
        }
    ...
    private void ButtonOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonOkActionPerformed
        ...
        try {
            ...
            jLabelNoteSuaGD.setText("");
        } catch (Exception e) {
            jLabelNoteSuaGD.setText("Vui lòng nhập đúng định dạng");
        }
        list.clear();
        thangNay();
        getTableTime(firstTime, seconTime);
    ...
    private quanlythuchi.components.ComboBox ChonThangCBBox;
    private quanlythuchi.components.Button DangxuatButton;
    private javax.swing.JDialog DialogHanMuc;
    private javax.swing.JDialog DialogSua;
    private quanlythuchi.components.Button LamMoiButton;
    ...
    private quanlythuchi.components.PanelSlide Slide;
    private quanlythuchi.components.Button SuaButton;
    private javax.swing.JPanel ThietLap;
    private javax.swing.JPanel ThongBao;
    private javax.swing.JPanel TongQuan;
    private quanlythuchi.components.Button XoaButton;
    private quanlythuchi.components.Button btnChon;
    ...
    private quanlythuchi.components.Button button29;
    private quanlythuchi.components.Button button3;
    private quanlythuchi.components.Button button30;
    private quanlythuchi.components.Button button31;
    private quanlythuchi.components.Button button32;
    private quanlythuchi.components.Button button33;
    private quanlythuchi.components.Button button4;
    private quanlythuchi.components.Button button5;
    private quanlythuchi.components.Button button6;
    private quanlythuchi.components.Button button7;
    private quanlythuchi.components.Button button8;
    private quanlythuchi.components.Button button9;
    private quanlythuchi.components.Button buttonGiaoDich;
    private quanlythuchi.components.Button buttonHome;
    private quanlythuchi.components.Button buttonSetting;
    private quanlythuchi.components.Button buttonThongBao;
    private quanlythuchi.components.ComboBox comboBox1;
    private quanlythuchi.components.ComboBox comboBox2;
    private quanlythuchi.components.ComboBox comboBox3;
    private quanlythuchi.components.ComboBox comboBox4;
    private quanlythuchi.components.ComboBox comboBoxBieuDo;
    private quanlythuchi.components.ComboBox<TheLoai> comboBoxTL;
    private quanlythuchi.components.ComboBox<TheLoai> comboBoxTLcon;
    private quanlythuchi.components.ComboBox<TheLoai> comboBoxTLcon1;
    private quanlythuchi.components.ComboBox comboBoxThuChi;
    ...
    private quanlythuchi.components.HistogramPanel histogramPanel;
    private quanlythuchi.components.HistogramPanel histogramPanel1;
    ...
    private quanlythuchi.components.PanelSlide panelSlideHanMuc;
    private quanlythuchi.components.PieChart pieChart1;
    private quanlythuchi.components.PieChart pieChart2;
    private quanlythuchi.components.ComboBox search;
    private quanlythuchi.components.TextField searchtextField;
    private javax.swing.JTable tableGanDay;
    private javax.swing.JScrollPane tableScrollPane;
    private javax.swing.JScrollPane tableScrollPane1;
    private quanlythuchi.components.TextField textDenNgay;
    private quanlythuchi.components.TextField textDenNgay1;
    private quanlythuchi.components.TextField textField1;
    private quanlythuchi.components.TextField textTuNgay;
    private quanlythuchi.components.TextField textTuNgay1;
    private quanlythuchi.components.TextField txtMoTa;
    private javax.swing.JFormattedTextField txtSoTien;
    private quanlythuchi.components.ComboBox<TheLoai> txtTheLoai;
    private quanlythuchi.components.TextField txtThoiGian;
    private quanlythuchi.components.TextField txt_mota;
    private quanlythuchi.components.TextField txt_sotien;
    private quanlythuchi.components.TextField txt_thoigian;
