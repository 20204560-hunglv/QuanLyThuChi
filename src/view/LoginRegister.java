...
public class LoginRegister extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panelSlide = new components.PanelSlide();
        ...
        buttonDangNhap = new components.Button();
    ...
    private void login() {
        ...
        if (uc.checkInput(username, password)) {
            MessageDialog messageDialog = new MessageDialog(this);
            messageDialog.showMessage("Lỗi", "Hãy nhập đầy đủ thông tin!");
        } else {
            labelNote.setText("");
            if (uc.signIn(username, password)) {
    ...
    private components.Button buttonDangNhap;
    ...
    private components.PanelSlide panelSlide;
